...
<head>
  ...
  <div class="navlinks">
    <a href="recette-petitdej.php" title="Petit déjeunr"  class="Les recettes">Recettes</a>
    <div>
...
<div class="banniere">
  ...
  <div class="row">
    <div class="col-6">
    <a href="rizetepinard.php" title="Riz aux épinards"  class="form-control">Riz aux épinards</a>
    </div>
    <div class="col-6">
  ...
  <div class="row">
    ...
    <div class="col-6">
    <a href="dombrecrevette.php"  title="Lasagnes"  class="form-control">Dombre et crevettes</a>
    </div>
  </div>
</form>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-6">
    <a href="rizetcolombo.php" title="Riz et colombo "  class="form-control">Riz et colombo</a>
    </div>
  </div>
</form>
    </div>
